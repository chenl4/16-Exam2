...
Authors: David Mutchler, Dave Fisher, Matt Boutell, Amanda Stouder,
         their colleagues and Lilin Chen.  April 2018.
...
def main():
    ...
    print(p1.get_age())  # Should print Happy birthday! and 10

    # Test celebrate_birthday(5):
    p1.celebrate_birthdays(5)
    print(p1.get_age())  # Should print Happy birthday! 5 times and 15

    # Test older_person:
    p2 = p1.older_person()
    print(p2.get_age())  # Should print 30
